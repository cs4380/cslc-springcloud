...
import com.cs.springcloud.admin.server.biz.SysDictValueBiz;
...
@Api(tags = "数据字典值")
public class SysDictValueController extends BaseController<SysDictValueBiz, SysDictValue> {
